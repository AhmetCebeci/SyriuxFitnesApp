...
namespace SyriuxFitnesApp.Migrations
{
    ...
    [Migration("20251211100430_TrainerSaatTipiDuzelt")]
    partial class TrainerSaatTipiDuzelt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SyriuxFitnesApp.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SyriuxFitnesApp.Models.Appointment", b =>
                {
            ...
            modelBuilder.Entity("SyriuxFitnesApp.Models.Trainer", b =>
                {
                    ...
                    b.Property<TimeSpan>("WorkEndHour")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("WorkStartHour")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SyriuxFitnesApp.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SyriuxFitnesApp.Models.Appointment", b =>
                {
                    b.HasOne("SyriuxFitnesApp.Models.AppUser", "Member")
                        .WithMany()
