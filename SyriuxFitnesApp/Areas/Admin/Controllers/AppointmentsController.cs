...
namespace SyriuxFitnesApp.Areas.Admin.Controllers
{
    ...
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AppointmentId,AppointmentDate,AppointmentTime,IsApproved,StoredPrice,StoredDuration,MemberId,TrainerId,ServiceId")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AppointmentId,AppointmentDate,AppointmentTime,IsApproved,StoredPrice,StoredDuration,MemberId,TrainerId,ServiceId")] Appointment appointment)
        {
